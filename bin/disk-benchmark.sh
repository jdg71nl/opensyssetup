...
# JDG:
# idea from:
# - https://www.jeffgeerling.com/tags/benchmarking
# - https://github.com/geerlingguy/pi-cluster/blob/master/benchmarks/disk-benchmark.sh
# > curl-save https://raw.githubusercontent.com/geerlingguy/pi-cluster/master/benchmarks/disk-benchmark.sh 
#
BASENAME=`basename $0`
echo "# running (script from 'jeffgeerling'): $BASENAME ... "
#.
