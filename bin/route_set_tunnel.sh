#!/bin/bash
#= route_set_tunnel.sh | updated: d230928
...
/sbin/ip route add 193.38.153.11 via 10.86.91.254
#
# now lead generic-internet traffic (including DNS) throught OpenVPN tunnel:
/sbin/ip route add 0.0.0.0/1 dev tun21
/sbin/ip route add 128.0.0.0/1 dev tun21
#
/sbin/ip route
